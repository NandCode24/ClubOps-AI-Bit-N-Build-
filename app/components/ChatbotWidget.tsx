...
const STARTER_PROMPTS = [
  ...
  {
    icon: (
      <svg className="w-5 h-5 text-[#859B62]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
      </svg>
    ),
    badge: "AUTO-REALLOCATION",
    badgeColor: "bg-[#EAF0E2] text-[#45522B] dark:bg-[#202A1B] dark:text-[#9AB277] border-[#859B62]/30 dark:border-[#859B62]/50",
      ...
      {!isOpen && (
        <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 animate-float-gentle">
          ...
          <button
            ...
            className="group relative flex items-center gap-3 rounded-2xl bg-white/95 dark:bg-[#151D13]/95 backdrop-blur-xl border border-[#859B62]/30 dark:border-[#859B62]/40 shadow-[0_12px_35px_rgba(69,82,43,0.2)] hover:shadow-[0_16px_45px_rgba(69,82,43,0.3)] px-4 py-2.5 text-left hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer"
            aria-label="Open ClubOps Assistant"
          >
            <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-tr from-[#5C7040] via-[#738852] to-[#859B62] text-white shadow-md shadow-[#859B62]/25 shrink-0">
              <RadiantAiIcon className="w-5 h-5" variant="white" />
            </span>
            <div className="min-w-0">
              <div className="flex items-center gap-1.5">
                <span className="font-bold text-xs text-[#1B2213] dark:text-[#F4F6F0] leading-tight">
                  Need help with your club?
                </span>
                <span className="flex h-2 w-2 rounded-full bg-[#859B62] animate-pulse shrink-0" />
              </div>
        ...
        <div className="fixed bottom-4 sm:bottom-6 right-3 sm:right-6 z-50 flex flex-col w-[520px] max-w-[calc(100vw-28px)] h-[700px] max-h-[90vh] rounded-3xl bg-white/95 dark:bg-[#192015]/95 backdrop-blur-2xl border border-[#E2DDD0] dark:border-[#283422] shadow-[0_25px_70px_rgba(0,0,0,0.25)] dark:shadow-[0_25px_70px_rgba(0,0,0,0.8)] overflow-hidden transition-all duration-300 animate-in fade-in zoom-in-95">
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-4 select-text [scrollbar-width:thin] [scrollbar-color:rgba(156,163,175,0.3)_transparent] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-slate-200 dark:[&::-webkit-scrollbar-thumb]:bg-slate-800 [&::-webkit-scrollbar-thumb]:rounded-full">
            ...
            {messages.length === 0 && (
              <div className="space-y-4 py-2">
                ...
                <div className="rounded-2xl border border-[#859B62]/30 dark:border-[#859B62]/30 bg-gradient-to-br from-[#EAF0E2]/60 via-white to-[#F2ECE1] dark:from-[#202A1B]/50 dark:via-[#151D13]/60 dark:to-[#121810] p-5 text-center shadow-xs">
                  ...
                  <h4 className="font-bold text-[#1B2213] dark:text-[#F4F6F0] text-base sm:text-lg tracking-tight">
                    How can I assist your club today?
                  </h4>
                  <p className="text-xs sm:text-[13px] text-[#45522B]/80 dark:text-[#CBD8C4]/80 leading-relaxed max-w-sm mx-auto mt-1.5">
                ...
                <div className="space-y-2">
                  <div className="text-xs font-bold uppercase tracking-wider text-[#6B7E64] dark:text-[#98AA90] px-1">
                    Suggested Questions
                  </div>
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2 mb-0.5">
                            <span className="font-semibold text-[#1B2213] dark:text-[#F4F6F0] text-[13px] group-hover:text-[#859B62] dark:group-hover:text-[#9AB277] transition-colors">
                              {item.title}
                            </span>
                          ...
                          <p className="text-xs text-[#5C7040] dark:text-[#98AA90] line-clamp-1">
                            {item.description}
                          </p>
                        </div>
                        <span className="text-[#B7CCA0] dark:text-[#5C7040] group-hover:text-[#859B62] dark:group-hover:text-[#9AB277] group-hover:translate-x-1 transition-all text-base shrink-0 self-center">
                          →
                        </span>
                      </button>
                    ))}
            ...
            {messages.map((msg) => (
              ...
              >
                {msg.role === "assistant" && (
                  <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-tr from-[#5C7040] via-[#738852] to-[#859B62] text-white shrink-0 mt-0.5 shadow-md shadow-[#859B62]/20">
                    <RadiantAiIcon className="w-5 h-5" variant="white" />
                  </div>
                )}
