...
// DELETE /api/clubs/by-code/[code] - Delete club and all its associations (LEADER ONLY)
export async function DELETE(
  ...
  try {
    ...
    console.error("Error in DELETE /api/clubs/by-code/[code]:", error);
    return NextResponse.json(
